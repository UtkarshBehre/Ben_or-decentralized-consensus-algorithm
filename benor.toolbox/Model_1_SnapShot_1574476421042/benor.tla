...
\* Last modified Fri Nov 22 21:26:41 EST 2019 by Utkarsh
...
So we ran the model with only Agreement and Progress being checked to test if Agreement is 
violated with the following possible INPUT combinations as below:
